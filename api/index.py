...
import tempfile
from agents import (
    Runner, Agent, set_default_openai_api, set_tracing_disabled,
    SQLiteSession, AsyncOpenAI, set_default_openai_client
)
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["*"],  # later restrict to Next.js domain
